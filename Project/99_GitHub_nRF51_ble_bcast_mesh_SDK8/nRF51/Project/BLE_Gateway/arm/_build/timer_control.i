...
#line 37 "..\\..\\..\\rbc_mesh\\src\\timer_control.c"
...
#line 38 "..\\..\\..\\rbc_mesh\\src\\timer_control.c"
...
#line 40 "..\\..\\..\\rbc_mesh\\src\\timer_control.c"
...
#line 41 "..\\..\\..\\rbc_mesh\\src\\timer_control.c"
...
#line 43 "..\\..\\..\\rbc_mesh\\src\\timer_control.c"
#line 1 "..\\..\\..\\..\\..\\..\\components\\softdevice\\s110\\headers\\nrf_soc.h"
...
#line 44 "..\\..\\..\\rbc_mesh\\src\\timer_control.c"

#line 46 "..\\..\\..\\rbc_mesh\\src\\timer_control.c"
...
static uint8_t get_available_timer(void)
{
    ...
    {
        if (((NRF_TIMER_Type *) 0x40008000UL)->EVENTS_COMPARE[i] == 1 || (never_used_bitmap & (1 << i)))
        {
             
            never_used_bitmap &= ~(1 << i);
            ((NRF_PPI_Type *) 0x4001F000UL)->CHENCLR = (1 << (8 + i));
            active_callbacks &= ~(1 << i);
            ((NRF_TIMER_Type *) 0x40008000UL)->EVENTS_COMPARE[i] = 0;
            return i;
        }
    }
...
void timer_event_handler(void)
{
    ...
    if (reference_channel != 0xFF && ((NRF_TIMER_Type *) 0x40008000UL)->EVENTS_COMPARE[reference_channel])
    {
        ((NRF_TIMER_Type *) 0x40008000UL)->EVENTS_COMPARE[reference_channel] = 0;
        reference_point = ((NRF_TIMER_Type *) 0x40008000UL)->CC[reference_channel] + reference_offset;
        ((NRF_TIMER_Type *) 0x40008000UL)->INTENCLR = (1 << ((16UL) + reference_channel));
        ((NRF_PPI_Type *) 0x4001F000UL)->CHENCLR  = (1 << (8 + reference_channel));
    ...
    for (uint8_t i = 0; i < 4; ++i)
    {
        if ((active_callbacks & (1 << i)) && ((NRF_TIMER_Type *) 0x40008000UL)->EVENTS_COMPARE[i])
        {
            timer_callback cb = callbacks[i];
            active_callbacks &= ~(1 << i);
            ((NRF_TIMER_Type *) 0x40008000UL)->INTENCLR = (1 << ((16UL) + i));


            if ((uint32_t)cb < 0x18000UL || (uint32_t)cb > 0x20000000UL){do { const uint32_t LOCAL_ERR_CODE = (((0x0) + 16)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 0, 0); } while (0); } } while (0);};
...
uint8_t timer_order_cb(uint32_t time, timer_callback callback)
{
    ...
    if (timer == 0xFF)
    {
        do { const uint32_t LOCAL_ERR_CODE = (((0x0) + 4)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 0, 0); } while (0); } } while (0);
    }

    ((NRF_TIMER_Type *) 0x40008000UL)->CC[timer] = reference_point + time;
    ((NRF_TIMER_Type *) 0x40008000UL)->EVENTS_COMPARE[timer] = 0;
    ((NRF_TIMER_Type *) 0x40008000UL)->INTENSET  = (1 << ((16UL) + timer));
...
uint8_t timer_order_cb_ppi(uint32_t time, timer_callback callback, uint32_t* task)
{
    ...
    ((NRF_TIMER_Type *) 0x40008000UL)->EVENTS_COMPARE[timer] = 0;
    ((NRF_TIMER_Type *) 0x40008000UL)->INTENCLR = (1 << ((16UL) + timer));
    ((NRF_TIMER_Type *) 0x40008000UL)->CC[timer] = reference_point + time;
    ...
    ((NRF_PPI_Type *) 0x4001F000UL)->CH[8 + timer].EEP   = (uint32_t) &(((NRF_TIMER_Type *) 0x40008000UL)->EVENTS_COMPARE[timer]);
	((NRF_PPI_Type *) 0x4001F000UL)->CH[8 + timer].TEP   = (uint32_t) task;
	((NRF_PPI_Type *) 0x4001F000UL)->CHENSET 			                  = (1 << (8 + timer));
...
void timer_abort(uint8_t timer_index)
{
    if (timer_index < 4)
    {
        ((NRF_TIMER_Type *) 0x40008000UL)->INTENCLR = (1 << ((16UL) + timer_index));
        active_callbacks &= ~(1 << timer_index);
        ((NRF_PPI_Type *) 0x4001F000UL)->CHENCLR = (1 << (8 + timer_index));
...
uint32_t timer_get_timestamp(void)
{
    ...
    ((NRF_TIMER_Type *) 0x40008000UL)->TASKS_CAPTURE[timer] = 1;


    uint32_t stamp = ((NRF_TIMER_Type *) 0x40008000UL)->CC[timer];
...
void timer_reference_point_trigger(uint32_t* trigger_event, int32_t time_offset)
{
	...
	((NRF_PPI_Type *) 0x4001F000UL)->CH[timer].EEP   = (uint32_t) trigger_event;
    ((NRF_PPI_Type *) 0x4001F000UL)->CH[timer].TEP   = (uint32_t) &(((NRF_TIMER_Type *) 0x40008000UL)->TASKS_CAPTURE[timer]);
	((NRF_PPI_Type *) 0x4001F000UL)->CHENSET 		 = (1 << (8 + timer));
}
...
void timer_init(void)
{
    ...
    ((NRF_TIMER_Type *) 0x40008000UL)->EVENTS_COMPARE[2] = 0;
    ((NRF_TIMER_Type *) 0x40008000UL)->EVENTS_COMPARE[3] = 0;
