...
#line 36 "..\\..\\..\\rbc_mesh\\src\\event_handler.c"
...
#line 37 "..\\..\\..\\rbc_mesh\\src\\event_handler.c"
...
#line 38 "..\\..\\..\\rbc_mesh\\src\\event_handler.c"
...
#line 39 "..\\..\\..\\rbc_mesh\\src\\event_handler.c"
...
#line 40 "..\\..\\..\\rbc_mesh\\src\\event_handler.c"
...
#line 41 "..\\..\\..\\rbc_mesh\\src\\event_handler.c"



static fifo_t g_async_evt_fifo;
static async_event_t g_async_evt_fifo_buffer[(8)];
static fifo_t g_async_evt_fifo_ts;
static async_event_t g_async_evt_fifo_buffer_ts[(8)];
static _Bool g_is_initialized;
...
static void async_event_execute(async_event_t* evt)
{
    ...
    switch (evt->type)
    {
        case EVENT_TYPE_RADIO_RX:
            if ((uint32_t)evt->callback . radio_rx . function < 0x18000UL || (uint32_t)evt->callback . radio_rx . function > 0x20000000UL){do { const uint32_t LOCAL_ERR_CODE = (((0x0) + 16)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 0, 0); } while (0); } } while (0);};
            (*evt->callback.radio_rx.function)(evt->callback.radio_rx.data);
            break;
        case EVENT_TYPE_RADIO_TX:
            if ((uint32_t)evt->callback . radio_tx < 0x18000UL || (uint32_t)evt->callback . radio_tx > 0x20000000UL){do { const uint32_t LOCAL_ERR_CODE = (((0x0) + 16)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 0, 0); } while (0); } } while (0);};
            (*evt->callback.radio_tx)();
            break;
        case EVENT_TYPE_TIMER:
            if ((uint32_t)evt->callback . timer < 0x18000UL || (uint32_t)evt->callback . timer > 0x20000000UL){do { const uint32_t LOCAL_ERR_CODE = (((0x0) + 16)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 0, 0); } while (0); } } while (0);};
            (*evt->callback.timer)();
            break;
        case EVENT_TYPE_GENERIC:
            if ((uint32_t)evt->callback . generic < 0x18000UL || (uint32_t)evt->callback . generic > 0x20000000UL){do { const uint32_t LOCAL_ERR_CODE = (((0x0) + 16)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 0, 0); } while (0); } } while (0);};
...
static _Bool event_fifo_pop(fifo_t* evt_fifo)
{
    async_event_t evt;
