...
#line 37 "..\\..\\..\\rbc_mesh\\src\\radio_control.c"
...
#line 38 "..\\..\\..\\rbc_mesh\\src\\radio_control.c"
...
#line 39 "..\\..\\..\\rbc_mesh\\src\\radio_control.c"
...
#line 40 "..\\..\\..\\rbc_mesh\\src\\radio_control.c"
#line 41 "..\\..\\..\\rbc_mesh\\src\\radio_control.c"
...
#line 42 "..\\..\\..\\rbc_mesh\\src\\radio_control.c"
#line 1 "C:\\Keil_v5\\ARM\\PACK\\NordicSemiconductor\\nRF_DeviceFamilyPack\\7.2.1\\Device\\Include\\nrf.h"
...
#line 43 "..\\..\\..\\rbc_mesh\\src\\radio_control.c"
#line 1 "..\\..\\..\\..\\..\\..\\components\\softdevice\\s110\\headers\\nrf_sdm.h"
...
#line 44 "..\\..\\..\\rbc_mesh\\src\\radio_control.c"
...
#line 45 "..\\..\\..\\rbc_mesh\\src\\radio_control.c"

#line 47 "..\\..\\..\\rbc_mesh\\src\\radio_control.c"
...
#line 48 "..\\..\\..\\rbc_mesh\\src\\radio_control.c"
...
static radio_event_t radio_fifo_queue[8];
...
static void radio_channel_set(uint8_t ch)
{
    if (ch <= 10)
    {
        ((NRF_RADIO_Type *) 0x40001000UL)->FREQUENCY = 4 + ch * 2;
    }
    else if (ch <= 36)
    {
        ((NRF_RADIO_Type *) 0x40001000UL)->FREQUENCY = 6 + ch * 2;
    }
    else
    {
        uint32_t adv_freqs[] = {2, 26, 80};
        ((NRF_RADIO_Type *) 0x40001000UL)->FREQUENCY = adv_freqs[(ch - 37)];
    }

    ((NRF_RADIO_Type *) 0x40001000UL)->DATAWHITEIV = ch & (0x7FUL << (0UL));

}

static _Bool radio_will_go_to_disabled_state(void)
{
    ...
    return ((fifo_get_len(&radio_fifo) == 2 &&
        (((NRF_RADIO_Type *) 0x40001000UL)->EVENTS_READY) && !(((NRF_RADIO_Type *) 0x40001000UL)->EVENTS_END)) ||
        (current_evt.channel != next_evt.channel));
}

static void setup_rx_timeout(uint32_t rx_start_time)
{
    rx_abort_timer_index = timer_order_cb_ppi(rx_start_time + (15080),
        rx_abort_cb,
        (uint32_t*) &(((NRF_RADIO_Type *) 0x40001000UL)->TASKS_DISABLE));
}
...
static void radio_transition_end(_Bool successful_transmission)
{
     
    _Bool crc_status = ((NRF_RADIO_Type *) 0x40001000UL)->CRCSTATUS;
    ...
    _Bool fly_through_disable = ((((NRF_RADIO_Type *) 0x40001000UL)->SHORTS &
        ((0x1UL << (3UL)) | (0x1UL << (2UL)))) > 0);
    ...
    else
    {
        ...
        {
            timer_order_ppi(evt.start_time, (uint32_t*) &(((NRF_RADIO_Type *) 0x40001000UL)->TASKS_START));
        }
        ...
        {
            ;
            ((NRF_RADIO_Type *) 0x40001000UL)->RXADDRESSES = evt.access_address;
            radio_state = RADIO_STATE_RX;

            ((NRF_RADIO_Type *) 0x40001000UL)->PACKETPTR = (uint32_t) rx_data[current_rx_buf];
            ((NRF_RADIO_Type *) 0x40001000UL)->INTENSET = (0x1UL << (1UL));
        ...
        {
            ;
            ((NRF_RADIO_Type *) 0x40001000UL)->TXADDRESS = evt.access_address;
            radio_state = RADIO_STATE_TX;
            ((NRF_RADIO_Type *) 0x40001000UL)->PACKETPTR = (uint32_t) &evt.packet_ptr[0];
            ((NRF_RADIO_Type *) 0x40001000UL)->INTENCLR = (0x1UL << (1UL));
            ;
        ...
        else
        {
                ...
                next_evt.channel != evt.channel)
            {
                ...
                {
                    ((NRF_RADIO_Type *) 0x40001000UL)->SHORTS |= (0x1UL << (3UL));
                }
                else  
                {
                    ((NRF_RADIO_Type *) 0x40001000UL)->SHORTS |= (0x1UL << (2UL));
                }
            }
        }
    }
    ...
    if (prev_evt.callback.tx != 0)
    {
        if ((uint32_t)prev_evt . callback . rx < 0x18000UL || (uint32_t)prev_evt . callback . rx > 0x20000000UL){do { const uint32_t LOCAL_ERR_CODE = (((0x0) + 16)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 0, 0); } while (0); } } while (0);};
...
void radio_init(uint32_t access_address)
{
    ...
    ((NRF_RADIO_Type *) 0x40001000UL)->POWER            = (((0UL) << (0UL)) & (0x1UL << (0UL)));
    ((NRF_RADIO_Type *) 0x40001000UL)->POWER            = (((1UL)  << (0UL)) & (0x1UL << (0UL)));



     
    ((NRF_RADIO_Type *) 0x40001000UL)->TXPOWER      = (((0x00UL) << (0UL)) & (0xFFUL << (0UL)));
    ((NRF_RADIO_Type *) 0x40001000UL)->MODE 	    = (((0x03UL) << (0UL)) & (0x3UL << (0UL)));

    ((NRF_RADIO_Type *) 0x40001000UL)->FREQUENCY 	    = 2;					
    ((NRF_RADIO_Type *) 0x40001000UL)->DATAWHITEIV      = 37;					


     
    ((NRF_RADIO_Type *) 0x40001000UL)->PREFIX0	    = ((access_address >> 24) & 0x000000FF);
    ((NRF_RADIO_Type *) 0x40001000UL)->BASE0 		= ((access_address << 8) & 0xFFFFFF00);
    ((NRF_RADIO_Type *) 0x40001000UL)->TXADDRESS    = 0x00;			    
    ((NRF_RADIO_Type *) 0x40001000UL)->RXADDRESSES  = 0x01;				

     
    ((NRF_RADIO_Type *) 0x40001000UL)->PCNF0 =  (
                          (((1UL) << (8UL)) & (0x1UL << (8UL)))    
                        | (((2UL) << (16UL)) & (0xFUL << (16UL)))    
                        | (((6UL) << (0UL)) & (0xFUL << (0UL)))    
                      );
    ...
    ((NRF_RADIO_Type *) 0x40001000UL)->PCNF1 =  (
                          (((37UL)                          << (0UL))  & (0xFFUL << (0UL)))   
                        | (((0UL)                           << (8UL)) & (0xFFUL << (8UL)))	
                        | (((3UL)                           << (16UL))   & (0x7UL << (16UL)))    
                        | ((((0UL))     << (24UL))  & (0x1UL << (24UL)))   
    ...
    ((NRF_RADIO_Type *) 0x40001000UL)->CRCPOLY = ((0x00065B << (0UL)) & (0xFFFFFFUL << (0UL)));    
    ((NRF_RADIO_Type *) 0x40001000UL)->CRCCNF = ((((1UL)) << (8UL)) & (0x1UL << (8UL)))
                      | ((((3UL))      << (0UL))       & (0x3UL << (0UL)));

    ((NRF_RADIO_Type *) 0x40001000UL)->CRCINIT = ((0x555555 << (0UL)) & (0xFFFFFFUL << (0UL)));    
     
    ((NRF_RADIO_Type *) 0x40001000UL)->TIFS = 148;

     
    radio_fifo.array_len = 8;
    radio_fifo.elem_array = radio_fifo_queue;
    radio_fifo.elem_size = sizeof(radio_event_t);
    radio_fifo.memcpy_fptr = 0;
...
void radio_order(radio_event_t* radio_event)
{
    ...
    if (radio_state == RADIO_STATE_DISABLED)
    {
        ...
        {
            ((NRF_RADIO_Type *) 0x40001000UL)->PACKETPTR = (uint32_t) &radio_event->packet_ptr[0];
            ((NRF_RADIO_Type *) 0x40001000UL)->INTENCLR = (0x1UL << (1UL));
            ((NRF_RADIO_Type *) 0x40001000UL)->TASKS_TXEN = 1;
            radio_state = RADIO_STATE_TX;
            ;
        ...
        {
            timer_order_ppi(radio_event->start_time, (uint32_t*) &(((NRF_RADIO_Type *) 0x40001000UL)->TASKS_START));
        }

        ((NRF_RADIO_Type *) 0x40001000UL)->INTENSET = (0x1UL << (3UL));
...
void radio_disable(void)
{
    ...
    ((NRF_RADIO_Type *) 0x40001000UL)->SHORTS = 0;
    ((NRF_RADIO_Type *) 0x40001000UL)->INTENCLR = 0xFFFFFFFF;
...
void radio_event_handler(void)
{
    if ((((NRF_RADIO_Type *) 0x40001000UL)->EVENTS_END == 1))
    {
        ((NRF_RADIO_Type *) 0x40001000UL)->EVENTS_END = 0;
        radio_transition_end(1);
    }
    switch (radio_state)
    {
        case RADIO_STATE_RX:
            if ((((NRF_RADIO_Type *) 0x40001000UL)->EVENTS_ADDRESS == 1) && rx_abort_timer_index != 0xFF)
            {
                timer_abort(rx_abort_timer_index);
            }
